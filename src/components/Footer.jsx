...
const Footer = () => {
  return (
    <footer className=" text-gray-800 bg-gray-200 font-sans py-5 w-full">
      <div className="max-w-6xl mx-auto px-5">
        <div className="flex flex-wrap justify-between mb-5">
          <div className="w-full md:w-1/5 mb-5 md:mb-0">
            <img src={logo} alt="Flight Expert Logo" className="h-10 mb-2" />

            <p className="p-2 mr-2 text-blue-500 font-arial text-sm tracking-wide">
              Trip Expert Nepal (main Branch)
              <br />
              90/1 Motijheel City Centre Level 25-B-1, Lift 26 Dhaka 1000,
              Bangladesh
            </p>
            <div className="flex justify-center space-x-3 text-blue-500 text-lg mt-2">
              <a href="#">
          ...
          <div className="w-full md:w-1/5 mb-5 md:mb-0">
            ...
            <p className="text-blue-500 font-sans">+88-09617-111-888</p>
            <p className="text-blue-500">sales@flightexpert.com</p>
            <p className="text-black font-sans font-extralight ">
          ...
          <div className="w-[390px] h-[180px] md:w-1/5 mb-5 md:mb-0">
            ...
            <img
              src={banklogo}
              alt="Payments"
              className="my-4 h-32 w-full cursor-pointer"
            />
          </div>
        </div>
        ...
        <div className="border-t border-gray-300 py-6">
          <div className="flex flex-wrap justify-between">
            <div className="w-1/5 text-center mb-1">
              <h4 className="mb-2 text-md font-bold text-gray-400">
                Accredited Member
              </h4>
              <img
                src={basis}
            ...
            <div className="w-1/5 text-center mb-5">
              ...
              <img
                src={duns}
                alt="DUNS Registered"
                className="h-10 mb-2 pl-10 ml-9"
              />
            </div>
            <div className="w-1/5 text-center mb-5">
              <h4 className="mb-2 text-md font-bold text-gray-400">
            ...
            <div className="w-1/5 text-center mb-5">
              ...
              <img
                src={google}
                alt="Google"
                className="h-12  mb-2 pl-10 ml-9"
              />
            </div>
            <div className="w-1/5 text-center mb-5">
              <h4 className="mb-2 text-md font-bold text-gray-400">
