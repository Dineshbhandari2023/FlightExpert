...
const FareType = () => {
  ...
  return (
    <div className="flex items-center space-x-1 ml-3">
      <label className="font-semibold font-mono tracking-tighter text-gray-700">
        Fare Type:
      </label>
            ...
            {fare === "Umrah Fares" && hoveredFare === "Umrah Fares" && (
              <div className="absolute top-full mt-1 left-0 p-2 w-64 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                ...
                <div className="text-gray-600 text-xs">
                  ...
                  Umrah Visa and are not traveling during the restricted periods
                  set by the Kingdom of Saudi Arabia. If a traveler does not
                  meet these conditions, the airline will deny boarding.
                </div>
              </div>
            )}
            {fare === "Student Fares" && hoveredFare === "Student Fares" && (
              <div className="absolute top-full mt-1 left-0 p-2 w-64 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                ...
                <div className="text-gray-600 text-xs">
                  ...
                  mandatory, else the passenger may be denied boarding or asked
